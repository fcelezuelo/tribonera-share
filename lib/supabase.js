...
if (SUPABASE_URL && SUPABASE_KEY) {
  ...
  console.log('[Supabase] Variáveis de ambiente SUPABASE_URL / SUPABASE_KEY não configuradas. Operando com persistência JSON local e espelhamento Supabase pronto.');
}
...
export const db = {
  ...
  async init(adminCode, adminPassword = 'admin') {
    ...
    // Se o Supabase estiver conectado, sincronizar tabelas
